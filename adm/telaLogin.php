...
<head>
    ...
    <link rel='stylesheet' type='text/css' meida='screen' href='##' />
                ...
                <div class="card border-0 shadow rounded-3 my-5">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <form method="post" action="login.php">
                            ...
                            <div class="form-floating mb-3">
                                <input type="password" class="form-control" id="txtSenha" name="senha_usuario"
                            ...
                            <div class="d-grid">
                                <input class="btn btn-primary btn-login text-uppercase fw-bold" type="submit"
                                    value="Entrar" />
                            </div>
                            <div class="d-grid py-2">
                                <input class="btn btn-secondary btn-login text-uppercase fw-bold" type="reset"
                                    value="Limpar" />
                            </div>
                            <hr class="my-4">
